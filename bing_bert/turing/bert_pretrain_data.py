...
def add_input_output_files(input_file, filename):
...
for filename in os.listdir(args.input_dir):
    ...
    if os.path.isdir(input_file):
      for filename2 in os.listdir(input_file):
        input_file2 = os.path.join(input_file, filename2)
        add_input_output_files(input_file2, filename + "." + filename2)
    else:
      add_input_output_files(input_file, filename)
